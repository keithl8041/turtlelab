// Browser-compatible ES module — mirrors lib/turtle-program.js
// Used by the frontend for client-side validation and explanation without a server round-trip.
...
export function parseDisplayCode(code) {
